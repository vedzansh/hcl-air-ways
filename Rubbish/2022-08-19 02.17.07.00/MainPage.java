        ...
        try {
            ...
            if (ch == 1) {
                ...
                if (ch2 == 1) {
                    ...
                    // cl.setString(4, name);
                    // cl.setString(5, gender);
                    // cl.setString(6, ph_no);
                    // cl.setString(7, passport_no);
                    // cl.setString(8,f_code);
                ...
                String hello = "TICKET CANCELLED SUCCESSFULLY....!!";
