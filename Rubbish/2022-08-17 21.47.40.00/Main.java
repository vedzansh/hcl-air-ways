            ...
            if (pass.equals(P)) {
                ...
                if (ch == 1) {
                    ...
                    if (ch2 == 1) {
                        ...
                        String t="insert into ticket values(1002,'"+pnr_no+"','"+f_class+"')";
                        stmt.executeQuery(t);
                        //ps.setString(1,pnr_no);
                        //ps.setString(2,f_class);
                        ResultSet rs2=stmt.executeQuery("select*from ticket where pnr_no='"+pnr_no+"'");
                        rs2.next();
                        ticket_id=rs2.getString(1);
                        String r="INSERT INTO  reservation VALUES('"+pnr_no+"', '"+ticket_id+"', '"+f_code+"', '"+j_date+"', '"+j_time+"', '"+f_src+"', '"+f_dst+"')";
                    ...
                    String s="delete from reservation where";
