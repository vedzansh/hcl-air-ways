...
public class MainPage extends Thread {
    ...
    static void adminconsole() throws SQLException, ClassNotFoundException {
        ...
        if (ch4 == 1) {
            ...
            System.out.println("filghts detail");
            String j="select*from flight";
            Statement stmt=conn.createStatement();
            ResultSet rs=stmt.executeQuery(j);
            while (rs.next()){
                System.out.println("Flight code : "+1);
                System.out.println("Flight name : "+2);
                System.out.println("Source loction : "+3);
                System.out.print("Destination : "+4);
                System.out.print("time : "+5);
                System.out.print("Charge "+6);
                System.out.print("Class"+7);
                System.out.println("");
