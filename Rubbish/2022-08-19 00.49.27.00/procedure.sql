...
(pnr_no in varchar2,  address in varchar2,  nationality  in varchar2,  name in varchar2,  gender in varchar2,  no in varchar2 ,  passport_no in varchar2 ,  f_code in varchar2 )
as 
begin
