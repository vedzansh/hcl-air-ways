...
/
create or replace PROCEDURE add_flight(f_code in varchar2,f_name in varchar2,f_src in varchar2,f_dst in varchar2,f_time in varchar2,f_charge in varchar2,f_class in varchar2)