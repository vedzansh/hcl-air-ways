...
CREATE OR REPLACE PROCEDURE cancel_ticket(t_id in int,pnr in varchar2,pnr_no in varchar2,c_date in varchar2,ticket_id in number,status out varchar2 ) AS
BEGIN
    DELETE FROM ticket
...
(pnr_no in varchar2,  address in varchar2,  nationality  in varchar2,  name in varchar2,  gender in varchar2,  no in varchar2 ,  passport_no in varchar2 ,  fl_code in varchar2 )
as 
begin
