...
(pnr_no in varchar2,  address in varchar2,  nationality  in varchar2,  name in varchar2,  gender in varchar2,  no in varchar2 ,  passport_no in varchar2 ,  f_code in varchar2 , ticket_id in int , jny_date in varchar2,  jny_time in varchar2,  src in varchar2,  dst in varchar2)
as 
begin
