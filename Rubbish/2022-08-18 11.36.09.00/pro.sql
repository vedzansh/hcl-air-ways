...
/
create or replace procedure cancel(pnr_no in varchar2,c_date in varchar2,ticket_id in varchar2,status in varchar2)
as 
id number;
begin
...
if (sql%found) then 
status:='CANCALTION DONE';
ELSE 
status:="CANCALATION FAILED"
end;
/