...
public class MainPage extends Thread {
    ...
    static void adminconsole() throws SQLException, ClassNotFoundException {
        ...
        if (ch4 == 1) {
            ...
            f_charge = sc5.nextLine();
            System.out.println("ENTER FLIGHT CLASS");
            f_class = sc5.nextLine();
            ...
            String time = sc4.nextLine();
            String b = "{call f_update(?,?,?)}";
            CallableStatement ca = conn.prepareCall(b);
            ca.setString(1, code);
            ca.setString(2, time);
    ...
    static void emding() {
        ...
        System.out.println("  |___                HCL      /~      ) FLY WAYS       \\).    ");
