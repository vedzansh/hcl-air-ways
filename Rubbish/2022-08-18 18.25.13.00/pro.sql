...
(pnr_no in varchar2,  address in varchar1,  nationality  in varchar2,  name in varchar2,  gender in varchar2,  no in varchar2 ,  passport_no in varchar2 ,  fl_code in varchar2 )
as 
begin
