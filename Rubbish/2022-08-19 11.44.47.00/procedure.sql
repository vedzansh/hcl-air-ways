...
create and replace procedure(pnr_no in varchar2,name out varchar2,passport_no out varchar)
as 
begin
select name passport_no from passenger where pnr_no=pnr_no;
select ticket_id from ticket whare pnr_no=pnr_no;
end;
/